<template>
	<div>
		...
		<div style="margin-bottom: 15px;">
			<Input v-model="content" maxlength="500" show-word-limit type="textarea" placeholder="Enter something..." :autosize="{minRows: 8,maxRows: 8}" />
		</div>
		<!--待上传图片预览区域-->
		...
		<!--上传图片的按钮-->
		<Upload name="Picture" multiple="multiple" ref="upload" :show-upload-list="false" :format="['jpg','jpeg','png']" :max-size="2048" :before-upload="handleBeforeUpload"
		 :on-format-error="handleFormatError" :on-exceeded-size="handleMaxSize" type="drag" action="http://www.saturnluo.cn:5000/weblog"
