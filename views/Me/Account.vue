							...
							<Cell>
								<div style="display: flex;justify-content: space-around;">
									<div class="horizontal">
										...
										:on-success="handleChangeAvatorSuccess" 
										:on-error="handleChangeAvatorError"
										:before-upload="handleBeforeChangeAvator">
							...
							<Cell>
								<div style="display: flex;justify-content: space-around;">
									<div class="horizontal">
										...
										<!--上传大号头像-->
										<Upload action="/global_icon" 
										name="Icon" 
										:show-upload-list="false" 
										:on-success="handleChangeAvatorSuccess2" 
										:on-error="handleChangeAvatorError2"
										:before-upload="handleBeforeChangeAvator2">
										    <Button icon="ios-cloud-upload-outline" style="margin-top: 5px;">Change</Button>
										</Upload>
									</div>
									<div class="horizontal">
	...
	export default {
		...
		mounted() {
			...
			this.$axios
				...
				.then(response=>{
					...
					response.data.info.sex == 1 ? this.gender = "md-man" : this.gender = "md-woman"
		...
		methods:{
			...
			submit:function(){
				...
				var url='/user/selfInfo?sex=' + gender
						+'&address=' + this.formItem1.address
						+'&description=' + this.formItem1.description
				this.$axios
					.put(url)
			...
			submit2:function(){
				//提交修改的大号信息
				var url='/user/globalAccount/description?description='+this.formItem2.description
				this.$axios
					.put(url)
					.then(response=>{
			...
			submit3:function(){
				...
				console.log('----------------------------------------------'+this.formItem3.name)
				this.$axios
					.post(url,{
