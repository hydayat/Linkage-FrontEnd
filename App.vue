		...
		<Layout>
			...
			<Layout>
				<Sider hide-trigger :style="{background: '#fff'}">
					...
					@on-select='select'>
						...
						<Submenu name="3">
							...
							<MenuItem name="3-1" @click.native='showAccount()'>
							Account
							</MenuItem>
							<MenuItem name="3-2" @click.native='showFriends()'>
							Friends
							</MenuItem>
							<MenuItem name="3-3" @click.native='showSubscription()'>
							Subscription
							</MenuItem>
						</Submenu>
					</Menu>
				...
				<Layout :style="{padding: '0 24px 24px'}">
					...
					@connectWebSockect='connectWebSockect'></router-view>
				</Layout>
			</Layout>
		</Layout>
	</div>
...
<script>
	...
	export default {
		...
		methods: {
			...
			onSubmitInvitation(formItem) { //发好友申请
